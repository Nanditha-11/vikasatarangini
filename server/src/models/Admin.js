...
const adminSchema = new mongoose.Schema(
  {
    ...
    welcomeMessage: { type: String, default: "శ్రీమన్నారాయణ! ఈ రోజు సెషన్‌కు హాజరైనందుకు ధన్యవాదాలు." },
    absentMessage: { type: String, default: "శ్రీమన్నారాయణ! ఈ రోజు మీరు స్వర్ణామృత ప్రాశనకు హాజరు కాలేదు. దయచేసి తదుపరి కార్యక్రమానికి హాజరుకాగలరు." },
    inviteTemplate: { type: String, default: "శ్రీమన్నారాయణ!\n\nవికాస తరంగిణికి స్వాగతం, {{name}}. దయచేసి ఈ క్రింది లింక్‌ను క్లిక్ చేయడం ద్వారా మా అధికారిక వాట్సాప్ గ్రూప్‌లో చేరండి:\n\n{{link}}" },
